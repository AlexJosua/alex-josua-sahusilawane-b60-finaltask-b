...
//add provinsi
app.post("/add-provinsi", checkUser, upload.single("photo"), addProvinsi);

app.get("/add-provinsi", checkUser, renderAddProvinsi);
...
//add kab
app.post("/add-kabupaten", checkUser, upload.single("image"), addKabupaten);

app.get("/add-kabupaten", checkUser, renderAddKabupaten);
